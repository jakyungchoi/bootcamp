  ...
  return (
    <div>
      ...
      <ResourceCrud
        ...
        title="협업 사례"
        description="참여 기업 연계 페이지 '협업 사례'에 로고가 옆으로 계속 흐르는 형태로 표시됩니다. 실제 협업이 생기면 여기에 추가하세요. 공개 화면에는 로고 이미지만 보이고(마우스를 올리면 기업명이 말풍선으로 뜹니다), 제목/설명은 화면에 표시되지 않는 내부 기록용입니다."
        titleField="title"
        fields={[
