...
export const BUILTIN_MENU: BuiltinMenuItem[] = [
  ...
  { key: "courses", href: "/admin/courses", label: "대표 교육 과정", desc: "운영 교육 과정 페이지의 과정 카드", order: 4 },
  { key: "curriculum", href: "/admin/curriculum", label: "커리큘럼 구성 단계", desc: "기초 역량 → 취업 연계 흐름", order: 5 },
  { key: "culture", href: "/admin/culture", label: "교육 문화 프로그램", desc: "인간 포텐업, 지식줍줍 등", order: 6 },
  { key: "learner-management", href: "/admin/learner-management", label: "학습자 관리 카드", desc: "출결, 학습 참여 등", order: 7 },
  { key: "support-plans", href: "/admin/support-plans", label: "학습부진자 지도 계획", desc: "과정별 지원 방식", order: 8 },
  { key: "quality-management", href: "/admin/quality-management", label: "교육 품질 관리", desc: "구분(카드)을 자유롭게 추가/삭제 가능", order: 9 },
  { key: "collaboration-tools", href: "/admin/collaboration-tools", label: "협업 도구", desc: "Notion, Slack 등", order: 10 },
  { key: "participation-types", href: "/admin/participation-types", label: "기업 참여 방식", desc: "참여 기업 연계 페이지 카드", order: 11 },
  { key: "company-flow", href: "/admin/company-flow", label: "이런 협업이 가능해요", desc: "기업과 함께할 수 있는 활동 목록", order: 12 },
  { key: "case-studies", href: "/admin/case-studies", label: "협업 사례", desc: "실제 기업 협업 사례", order: 13 },
];
